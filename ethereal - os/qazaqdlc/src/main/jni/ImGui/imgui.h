...
namespace ImGui
{
    ...
    IMGUI_API char*         GetGlobalBuffer();
	...
	//IMGUI_API bool          SliderObscuredFloat(const char* label, ObscuredFloat* v, ObscuredFloat v_min, ObscuredFloat v_max, const char* format = "%.3f", ImGuiSliderFlags flags = 0);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display.
   ...
   // IMGUI_API bool          SliderObscuredInt(const char* label, ObscuredInt* v, ObscuredInt v_min, ObscuredInt v_max, const char* format = "%d", ImGuiSliderFlags flags = 0);
...
struct ImDrawList
{
    ...
    void AddTriangleFilledMultiColor(const ImVec2 &a, const ImVec2 &b, const ImVec2 &c, ImU32 col_a,
