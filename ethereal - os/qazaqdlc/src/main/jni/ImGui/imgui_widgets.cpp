...
/*bool ImGui::SliderObscuredFloat(const char* label, ObscuredFloat* v, ObscuredFloat v_min, ObscuredFloat v_max, const char* format, ImGuiSliderFlags flags)
{
	return SliderScalar(label, ImGuiDataType_Float, v, &v_min, &v_max, format, flags);
}*/
...
/*bool ImGui::SliderObscuredInt(const char* label, ObscuredInt* v, ObscuredInt v_min, ObscuredInt v_max, const char* format, ImGuiSliderFlags flags)
{
    return SliderScalar(label, ImGuiDataType_S32, v, &v_min, &v_max, format, flags);
}*/
...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO,"ProCode_Modz", __VA_ARGS__))
#define  LOGE(...)  __android_log_print(ANDROID_LOG_ERROR,"ProCode_Modz",__VA_ARGS__)
